...
| ------------------------- | --------------------------------------------------------- | -------------------------------------- |
| `architecture.md`         | Service catalog, workspace layout, infrastructure map     | Always on session start                |
| `rules.md`                | 14 non-negotiable working standards                       | Always on session start                |
