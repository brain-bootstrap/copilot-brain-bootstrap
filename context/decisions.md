...
## ADR-001 — Use `context/` as the shared knowledge layer
...
**Decision:** All deep project knowledge lives in `context/*.md`. Both CLAUDE.md and `.github/copilot-instructions.md` reference these files via `read_file`. Files are always up-to-date in one place.  
